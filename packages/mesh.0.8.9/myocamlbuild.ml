(* OASIS_START *)
(* DO NOT EDIT (digest: 8f11ac339898fa84868c36ff217cfc88) *)
       ...
       [
          (["oasis_library_mesh_triangle_ccopt"; "compile"],
            [
               ...
               (OASISExpr.ENot (OASISExpr.EFlag "libtriangle"),
                 S
                   [
                      A "-ccopt";
                      A "-DTRILIBRARY";
          ...
          (["oasis_library_mesh_triangle_cclib"; "link"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EFlag "libtriangle",
                 S [A "-cclib"; A "-ltriangle"])
            ]);
          (["oasis_library_mesh_triangle_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EFlag "libtriangle", S [A "-ltriangle"])
            ])
       ];
     includes = [("tests", ["src"])]
  }
