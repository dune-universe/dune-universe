...
value _1_Hacl_Curve25519_51_scalarmult(value x3, value x2, value x1)
{
   ...
   Hacl_Curve25519_51_scalarmult(x4, x5, x6);
   return Val_unit;
}
value _2_Hacl_Curve25519_51_secret_to_public(value x9, value x8)
{
   unsigned char* x10 = CTYPES_PTR_OF_OCAML_BYTES(x9);
   unsigned char* x11 = CTYPES_PTR_OF_OCAML_BYTES(x8);
   Hacl_Curve25519_51_secret_to_public(x10, x11);
   return Val_unit;
}
value _3_Hacl_Curve25519_51_ecdh(value x15, value x14, value x13)
{
   ...
   _Bool x19 = Hacl_Curve25519_51_ecdh(x16, x17, x18);
   return Val_bool(x19);
}
