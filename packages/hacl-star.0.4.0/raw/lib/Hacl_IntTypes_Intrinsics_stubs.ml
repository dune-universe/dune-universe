...
external _2_Hacl_IntTypes_Intrinsics_add_carry_u64
  : Unsigned.uint64 -> Unsigned.uint64 -> Unsigned.uint64 -> _ CI.fatptr ->
    Unsigned.uint64 = "_2_Hacl_IntTypes_Intrinsics_add_carry_u64" 

external _3_Hacl_IntTypes_Intrinsics_sub_borrow_u32
  : Unsigned.uint32 -> Unsigned.uint32 -> Unsigned.uint32 -> _ CI.fatptr ->
    Unsigned.uint32 = "_3_Hacl_IntTypes_Intrinsics_sub_borrow_u32" 
...
| Function
  ...
  (fun x6 x7 x8 x9 ->
    ...
    _3_Hacl_IntTypes_Intrinsics_sub_borrow_u32 x6 x7 x8 x10)
| Function
    (CI.Primitive CI.Uint64_t,
     Function
       (CI.Primitive CI.Uint64_t,
  ...
  (fun x11 x12 x13 x14 ->
    ...
    _2_Hacl_IntTypes_Intrinsics_add_carry_u64 x11 x12 x13 x15)
| Function
    (CI.Primitive CI.Uint32_t,
     Function
       (CI.Primitive CI.Uint32_t,
