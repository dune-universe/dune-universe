...
value _1_Hacl_HKDF_Blake2b_256_expand_blake2b_256(value x6, value x5,
                                                  value x4, value x3,
                                                  value x2, value x1)
{
   ...
   Hacl_HKDF_Blake2b_256_expand_blake2b_256(x7, x8, x9, x12, x13, x16);
   return Val_unit;
}
value _1_Hacl_HKDF_Blake2b_256_expand_blake2b_256_byte6(value* argv,
                                                        int argc)
{
   value x20 = argv[5];
   value x21 = argv[4];
   ...
   value x25 = argv[0];
   return
     _1_Hacl_HKDF_Blake2b_256_expand_blake2b_256(x25, x24, x23, x22, 
                                                 x21, x20);
}
value _2_Hacl_HKDF_Blake2b_256_extract_blake2b_256(value x30, value x29,
                                                   value x28, value x27,
                                                   value x26)
{
   ...
   Hacl_HKDF_Blake2b_256_extract_blake2b_256(x31, x32, x33, x36, x37);
   return Val_unit;
}
