...
module Default : sig
  ...
  val json_of_result    : 'a encoder -> 'b encoder -> ('a, 'b) result encoder
  val json_of_hashtbl   : 'a encoder -> 'b encoder -> ('a, 'b) Hashtbl.t encoder
  ...
  val result_of_json    : 'a decoder -> 'b decoder -> ('a, 'b) result decoder
  val hashtbl_of_json   : 'a decoder -> 'b decoder -> ('a, 'b) Hashtbl.t decoder
end
