...
(** [to_float x] converts x to a float. Raises Invalid_arg if x is a
   scalar *)
val to_float : t -> float

(** [to_float x] converts x to a Mpqf.t. Raises Invalid_arg if x is a
   scalar *)
val to_mpqf : t -> Mpqf.t

(** [to_float x] converts x to an integer. Raises Invalid_arg if x is
   a scalar *)
val to_int : t -> int
