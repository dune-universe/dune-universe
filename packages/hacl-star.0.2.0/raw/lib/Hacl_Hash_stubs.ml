...
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  ...
  (fun x13 x15 ->
    let CI.CPointer x14 = x13 in _38_Hacl_Hash_Core_SHA2_finish_512 x14 x15)
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  "Hacl_Hash_Core_SHA2_finish_384" ->
  (fun x16 x18 ->
    let CI.CPointer x17 = x16 in _37_Hacl_Hash_Core_SHA2_finish_384 x17 x18)
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  "Hacl_Hash_Core_SHA2_finish_256" ->
  (fun x19 x21 ->
    let CI.CPointer x20 = x19 in _36_Hacl_Hash_Core_SHA2_finish_256 x20 x21)
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  "Hacl_Hash_Core_SHA2_finish_224" ->
  (fun x22 x24 ->
    let CI.CPointer x23 = x22 in _35_Hacl_Hash_Core_SHA2_finish_224 x23 x24)
| Function
...
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  ...
  (fun x29 x31 ->
    let CI.CPointer x30 = x29 in _32_Hacl_Hash_Core_SHA2_update_512 x30 x31)
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  "Hacl_Hash_Core_SHA2_update_384" ->
  (fun x32 x34 ->
    let CI.CPointer x33 = x32 in _31_Hacl_Hash_Core_SHA2_update_384 x33 x34)
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  "Hacl_Hash_Core_SHA2_update_256" ->
  (fun x35 x37 ->
    let CI.CPointer x36 = x35 in _30_Hacl_Hash_Core_SHA2_update_256 x36 x37)
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  "Hacl_Hash_Core_SHA2_update_224" ->
  (fun x38 x40 ->
    let CI.CPointer x39 = x38 in _29_Hacl_Hash_Core_SHA2_update_224 x39 x40)
| Function (CI.Pointer _, Returns CI.Void), "Hacl_Hash_Core_SHA2_init_512" ->
  (fun x41 ->
    let CI.CPointer x42 = x41 in _28_Hacl_Hash_Core_SHA2_init_512 x42)
| Function (CI.Pointer _, Returns CI.Void), "Hacl_Hash_Core_SHA2_init_384" ->
  (fun x43 ->
    let CI.CPointer x44 = x43 in _27_Hacl_Hash_Core_SHA2_init_384 x44)
| Function (CI.Pointer _, Returns CI.Void), "Hacl_Hash_Core_SHA2_init_256" ->
  (fun x45 ->
    let CI.CPointer x46 = x45 in _26_Hacl_Hash_Core_SHA2_init_256 x46)
| Function (CI.Pointer _, Returns CI.Void), "Hacl_Hash_Core_SHA2_init_224" ->
  (fun x47 ->
    let CI.CPointer x48 = x47 in _25_Hacl_Hash_Core_SHA2_init_224 x48)
| Function
    (CI.OCaml CI.Bytes,
     Function
...
| Function
  ...
  (fun x61 x63 x64 x65 ->
    ...
    _20_Hacl_Hash_SHA2_update_last_256 x62 x63 x64 x65)
| Function
    (CI.Pointer _,
     Function
       (CI.Primitive CI.Uint64_t,
  ...
  (fun x66 x68 x69 x70 ->
    ...
    _19_Hacl_Hash_SHA2_update_last_224 x67 x68 x69 x70)
| Function
    (CI.Pointer _,
     Function
       (CI.OCaml CI.Bytes,
  ...
  (fun x71 x73 x74 ->
    ...
    _18_Hacl_Hash_SHA2_update_multi_512 x72 x73 x74)
| Function
    (CI.Pointer _,
     Function
       (CI.OCaml CI.Bytes,
  ...
  (fun x75 x77 x78 ->
    ...
    _17_Hacl_Hash_SHA2_update_multi_384 x76 x77 x78)
| Function
    (CI.Pointer _,
     Function
       (CI.OCaml CI.Bytes,
  ...
  (fun x79 x81 x82 ->
    ...
    _16_Hacl_Hash_SHA2_update_multi_256 x80 x81 x82)
| Function
    (CI.Pointer _,
     Function
       (CI.OCaml CI.Bytes,
  ...
  (fun x83 x85 x86 ->
    ...
    _15_Hacl_Hash_SHA2_update_multi_224 x84 x85 x86)
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  "Hacl_Hash_Core_SHA1_legacy_finish" ->
  (fun x87 x89 ->
    let CI.CPointer x88 = x87 in
    _14_Hacl_Hash_Core_SHA1_legacy_finish x88 x89)
| Function
    (CI.Primitive CI.Uint64_t, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
...
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  ...
  (fun x92 x94 ->
    ...
    _12_Hacl_Hash_Core_SHA1_legacy_update x93 x94)
| Function (CI.Pointer _, Returns CI.Void), "Hacl_Hash_Core_SHA1_legacy_init" ->
  (fun x95 ->
    let CI.CPointer x96 = x95 in _11_Hacl_Hash_Core_SHA1_legacy_init x96)
| Function
    (CI.OCaml CI.Bytes,
     Function
       (CI.Primitive CI.Uint32_t,
...
| Function
  ...
  (fun x100 x102 x103 x104 ->
    ...
    _9_Hacl_Hash_SHA1_legacy_update_last x101 x102 x103 x104)
| Function
    (CI.Pointer _,
     Function
       (CI.OCaml CI.Bytes,
  ...
  (fun x105 x107 x108 ->
    ...
    _8_Hacl_Hash_SHA1_legacy_update_multi x106 x107 x108)
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  "Hacl_Hash_Core_MD5_legacy_finish" ->
  (fun x109 x111 ->
    let CI.CPointer x110 = x109 in
    _7_Hacl_Hash_Core_MD5_legacy_finish x110 x111)
| Function
    (CI.Primitive CI.Uint64_t, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
...
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  ...
  (fun x114 x116 ->
    ...
    _5_Hacl_Hash_Core_MD5_legacy_update x115 x116)
| Function (CI.Pointer _, Returns CI.Void), "Hacl_Hash_Core_MD5_legacy_init" ->
  (fun x117 ->
    let CI.CPointer x118 = x117 in _4_Hacl_Hash_Core_MD5_legacy_init x118)
| Function
    (CI.OCaml CI.Bytes,
     Function
       (CI.Primitive CI.Uint32_t,
...
| Function
  ...
  (fun x122 x124 x125 x126 ->
    ...
    _2_Hacl_Hash_MD5_legacy_update_last x123 x124 x125 x126)
| Function
    (CI.Pointer _,
     Function
       (CI.OCaml CI.Bytes,
  ...
  (fun x127 x129 x130 ->
    ...
    _1_Hacl_Hash_MD5_legacy_update_multi x128 x129 x130)
