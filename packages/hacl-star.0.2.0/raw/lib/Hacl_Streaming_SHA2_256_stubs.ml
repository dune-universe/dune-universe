...
| Function (CI.Pointer _, Returns CI.Void), "Hacl_Streaming_SHA2_256_free" ->
  (fun x1 -> let CI.CPointer x2 = x1 in _5_Hacl_Streaming_SHA2_256_free x2)
| Function (CI.Pointer _, Function (CI.OCaml CI.Bytes, Returns CI.Void)),
  "Hacl_Streaming_SHA2_256_finish" ->
  (fun x3 x5 ->
    let CI.CPointer x4 = x3 in _4_Hacl_Streaming_SHA2_256_finish x4 x5)
| Function
    (CI.Pointer _,
     Function
       (CI.OCaml CI.Bytes,
  ...
  (fun x6 x8 x9 ->
    let CI.CPointer x7 = x6 in _3_Hacl_Streaming_SHA2_256_update x7 x8 x9)
| Function (CI.Pointer _, Returns CI.Void), "Hacl_Streaming_SHA2_256_init" ->
  (fun x10 ->
    let CI.CPointer x11 = x10 in _2_Hacl_Streaming_SHA2_256_init x11)
| Function (CI.Void, Returns (CI.Pointer x13)),
  "Hacl_Streaming_SHA2_256_create_in" ->
  (fun x12 -> CI.make_ptr x13 (_1_Hacl_Streaming_SHA2_256_create_in x12))
