...
let rsa_suite =
  ...
  let expected_public =
    let n =
      Z.of_string
        ""
    in
...
let ec_suite =
  ...
  let expected_public =
    ...
    let public_point_y =
      Test_util.cstruct_of_hex
        "04E266926DF905285452A5BB4DFC70286D621BF8AF33FA8D2D2E4C5F86BF9DF3BA54CF49409095250A14A93B16D9B2F8B7D6E1C247CB939FE9F10924B54E0BA075"
    in
...
let suite = ["Rsa" >::: rsa_suite; "Ec" >::: ec_suite]
