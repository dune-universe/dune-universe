...
# -*- coding: utf-8 -*-
#
# ez_file documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ez_file.tex', 'ez_file Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ez_file', 'ez_file Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ez_file', 'ez_file Documentation',
     author, 'ez_file', 'One line description of project.',
     'Miscellaneous'),
]
