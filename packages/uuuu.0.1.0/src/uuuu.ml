...
let encoding_of_string = function
  | "ISO_8859-1:1987"  | "iso-ir-100" | "ISO_8859-1"  | "ISO-8859-1"  | "latin1"   | "l1"     | "IBM819"   | "CP819"    | "csISOLatin1"        -> `ISO_8859_1
  | "ISO_8859-2:1987"  | "iso-ir-101" | "ISO_8859-2"  | "ISO-8859-2"  | "latin2"   | "l2"                               | "csISOLatin2"        -> `ISO_8859_2
  | "ISO_8859-3:1988"  | "iso-ir-109" | "ISO_8859-3"  | "ISO-8859-3"  | "latin3"   | "l3"                               | "csISOLatin3"        -> `ISO_8859_3
  | "ISO_8859-4:1988"  | "iso-ir-110" | "ISO_8859-4"  | "ISO-8859-4"  | "latin4"   | "l4"                               | "csISOLatin4"        -> `ISO_8859_4
  | "ISO_8859-5:1988"  | "iso-ir-144" | "ISO_8859-5"  | "ISO-8859-5"  | "cyrillic"                                      | "csISOLatinCyrillic" -> `ISO_8859_5
  | "ISO_8859-6:1987"  | "iso-ir-127" | "ISO_8859-6"  | "ISO-8859-6"  | "arabic"              | "ECMA-114" | "ASMO-708" | "csISOLatinArabic"   -> `ISO_8859_6
  | "ISO_8859-7:1987"  | "iso-ir-126" | "ISO_8859-7"  | "ISO-8859-7"  | "greek"    | "greek8" | "ELOT_928" | "ECMA-118" | "csISOLatinGreek"    -> `ISO_8859_7
  | "ISO_8859-8:1988"  | "iso-ir-138" | "ISO_8859-8"  | "ISO-8859-8"  | "hebrew"                                        | "csISOLatinHebrew"   -> `ISO_8859_8
  | "ISO_8859-9:1989"  | "iso-ir-148" | "ISO_8859-9"  | "ISO-8859-9"  | "latin5"   | "l5"                               | "csISOLatin5"        -> `ISO_8859_9
  | "ISO_8859-10:1992" | "iso-ir-157"                 | "ISO-8859-10" | "latin6"   | "l6"                               | "csISOLatin6"        -> `ISO_8859_10
                                                      | "ISO-8859-11" | "TIS-620"                                       | "csTIS620"           -> `ISO_8859_11
                                                      | "ISO-8859-13"                                                   | "csISO885913"        -> `ISO_8859_13
  | "ISO_8859-14:1998" | "iso-ir-199" | "ISO_8859-14" | "ISO-8859-14" | "latin8"   | "l8"     | "iso-celtic"            | "csISO885914"        -> `ISO_8859_14
                                      | "ISO_8859-15" | "ISO-8859-15" | "Latin-9"                                       | "csISO885915"        -> `ISO_8859_15
  | "ISO_8859-16:2001" | "iso-ir-226" | "ISO_8859-16" | "ISO-8859-16" | "latin10"  | "l10"                              | "csISO885916"        -> `ISO_8859_16
...
type 'kind decoder =
  ...
  ; mutable pp : 'kind decoder -> [ `Malformed of string | `Uchar of Uchar.t ] -> decode
...
let end_of_input decoder =
  ...
  decoder.i_off <- 0;
  decoder.i_pos <- 0;
  decoder.i_len <- min_int (* XXX(dinosaure): return [`End] only when [rem < 0]. *)
...
let pp_iso_8859 decoder = function
  | `Malformed _ as v ->
    cr decoder false
  ; ncount decoder
  ; ncol decoder
  ...
  | `Uchar u as v ->
    ...
    | 0x000A (* LF *) ->
      ...
      cr decoder false
    ; if last_cr then decoder.k decoder
      else
        ( ncount decoder
        ; nline decoder
        ; v)
