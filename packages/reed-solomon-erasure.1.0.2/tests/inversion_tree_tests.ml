...
let test_get_inverted_matrix _ =
  let tree = make 3 2 in
...
let test_insert_inverted_matrix _ =
  let tree = make 3 2 in
...
let test_double_insert_inverted_matrix _ =
  let tree = make 3 2 in
...
let test_extended_inverted_matrix _ =
