...
let make_test_cases_decompose (assert_function, triplets) =
  List.map
    (fun (v, result) -> Printf.sprintf "%s" v >:: assert_function result v)
    triplets

let suite =
  "suite"
  >::: [ "test_parse_version_major"
         >::: make_test_cases_parse test_parse_version_major;
         "test_parse_version_minor"
         >::: make_test_cases_parse test_parse_version_minor;
         "test_parse_version_patch"
         >::: make_test_cases_parse test_parse_version_patch;
         "test_parse_and_compare_gt"
         >::: make_test_cases_compare test_parse_and_compare_gt;
         "test_parse_and_compare_eq"
