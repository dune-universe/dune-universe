...
# -*- coding: utf-8 -*-
#
# ez_config documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ez_config.tex', 'ez_config Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ez_config', 'ez_config Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ez_config', 'ez_config Documentation',
     author, 'ez_config', 'One line description of project.',
     'Miscellaneous'),
]
