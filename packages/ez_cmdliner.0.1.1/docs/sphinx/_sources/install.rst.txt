...
If :code:`ez_cmdliner` is available in your opam repository, you can just call::

  opam install ez_cmdliner

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`ez_cmdliner` in a directory.
