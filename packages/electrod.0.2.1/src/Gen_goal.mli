...
class virtual ['c] map :
  object ('c)
    constraint 'c =
      < visit_'i : 'd -> 'g -> 'h; visit_'v : 'd -> 'i -> 'j;
      visit_Add : 'd -> ibinop; visit_All : 'd -> quant;
      visit_And : 'd -> lbinop;
      visit_Block : 'd -> ('i, 'g) block -> ('j, 'h) prim_fml;
      visit_BoxJoin : 'd ->
      ('i, 'g) exp ->
      ('i, 'g) exp list -> ('j, 'h) prim_exp;
      visit_Card : 'd -> ('i, 'g) exp -> ('j, 'h) prim_iexp;
      visit_Compr : 'd ->
      ('i, 'g) sim_binding list ->
      ('i, 'g) block -> ('j, 'h) prim_exp;
      visit_Diff : 'd -> rbinop; visit_F : 'd -> lunop;
      visit_FIte : 'd ->
      ('i, 'g) fml ->
      ('i, 'g) fml -> ('i, 'g) fml -> ('j, 'h) prim_fml;
      visit_False : 'd -> ('j, 'h) prim_fml; visit_G : 'd -> lunop;
      visit_Gt : 'd -> icomp_op; visit_Gte : 'd -> icomp_op;
      visit_H : 'd -> lunop;
      visit_IBin : 'd ->
      ('i, 'g) iexp ->
      ibinop -> ('i, 'g) iexp -> ('j, 'h) prim_iexp;
      visit_IComp : 'd ->
      ('i, 'g) iexp ->
      icomp_op -> ('i, 'g) iexp -> ('j, 'h) prim_fml;
      ...
      visit_LBin : 'd ->
      ('i, 'g) fml ->
      lbinop -> ('i, 'g) fml -> ('j, 'h) prim_fml;
      visit_LProj : 'd -> rbinop;
      visit_LUn : 'd -> lunop -> ('i, 'g) fml -> ('j, 'h) prim_fml;
      visit_Let : 'd ->
      ('i, 'g) binding list ->
      ('i, 'g) block -> ('j, 'h) prim_fml;
      visit_Lone : 'd -> quant; visit_Lt : 'd -> icomp_op;
      visit_Lte : 'd -> icomp_op; visit_Neg : 'd -> iunop;
      visit_No : 'd -> quant; visit_None_ : 'd -> ('j, 'h) prim_exp;
      visit_Not : 'd -> lunop; visit_NotIn : 'd -> comp_op;
      visit_Num : 'd -> int -> ('j, 'h) prim_iexp; visit_O : 'd -> lunop;
      visit_One : 'd -> quant; visit_Or : 'd -> lbinop;
      ...
      visit_RBin : 'd ->
      ('i, 'g) exp ->
      rbinop -> ('i, 'g) exp -> ('j, 'h) prim_exp;
      visit_RComp : 'd ->
      ('i, 'g) exp ->
      comp_op -> ('i, 'g) exp -> ('j, 'h) prim_fml;
      visit_REq : 'd -> comp_op;
      visit_RIte : 'd ->
      ('i, 'g) fml ->
      ('i, 'g) exp -> ('i, 'g) exp -> ('j, 'h) prim_exp;
      visit_RLone : 'd -> rqualify; visit_RNEq : 'd -> comp_op;
      visit_RNo : 'd -> rqualify; visit_ROne : 'd -> rqualify;
      visit_RProj : 'd -> rbinop; visit_RSome : 'd -> rqualify;
      ...
      visit_True : 'd -> ('j, 'h) prim_fml; visit_U : 'd -> lbinop;
      visit_Union : 'd -> rbinop; visit_Univ : 'd -> ('j, 'h) prim_exp;
      visit_X : 'd -> lunop;
    ...
    method visit_Compr :
      'd ->
      ('i, 'g) sim_binding list -> ('i, 'g) block -> ('j, 'h) prim_exp
    method visit_Diff : 'd -> rbinop
    method visit_F : 'd -> lunop
    method visit_FIte :
      'd ->
      ('i, 'g) fml -> ('i, 'g) fml -> ('i, 'g) fml -> ('j, 'h) prim_fml
    ...
    method visit_Quant :
      'd ->
      quant ->
      ('i, 'g) sim_binding list -> ('i, 'g) block -> ('j, 'h) prim_fml
    ...
    method visit_RIte :
      'd ->
      ('i, 'g) fml -> ('i, 'g) exp -> ('i, 'g) exp -> ('j, 'h) prim_exp
...
class virtual ['c] fold :
  object ('c)
    constraint 'c =
      ...
      build_Diff : 'd -> 'p; build_F : 'd -> 'q;
      build_FIte : 'd -> 'j -> 'j -> 'j -> 'k; build_False : 'd -> 'k;
      build_G : 'd -> 'q; build_Gt : 'd -> 'r; build_Gte : 'd -> 'r;
      build_H : 'd -> 'q; build_IBin : 'd -> 's -> 'g -> 's -> 'n;
      build_IComp : 'd -> 's -> 'r -> 's -> 'k; build_IEq : 'd -> 'r;
      build_INEq : 'd -> 'r; build_IUn : 'd -> 't -> 's -> 'n;
      build_Iden : 'd -> 'm; build_Ident : 'd -> 'u -> 'm;
      build_Iff : 'd -> 'i; build_Imp : 'd -> 'i; build_In : 'd -> 'v;
      build_Inter : 'd -> 'p; build_Join : 'd -> 'p;
      build_LBin : 'd -> 'j -> 'i -> 'j -> 'k; build_LProj : 'd -> 'p;
      build_LUn : 'd -> 'q -> 'j -> 'k;
      build_Let : 'd -> ('o * 'l) list -> 'j list -> 'k;
      build_Lone : 'd -> 'h; build_Lt : 'd -> 'r; build_Lte : 'd -> 'r;
      build_Neg : 'd -> 't; build_No : 'd -> 'h; build_None_ : 
                                                   'd -> 'm; build_Not : 'd -> 'q; build_NotIn : 'd -> 'v;
      build_Num : 'd -> int -> 'n; build_O : 'd -> 'q;
      build_One : 'd -> 'h; build_Or : 'd -> 'i; build_Over : 'd -> 'p;
      build_P : 'd -> 'q; build_Prime : 'd -> 'l -> 'm;
      build_Prod : 'd -> 'p; build_Qual : 'd -> 'w -> 'l -> 'k;
      build_Quant : 'd ->
      'h -> (disj * 'o list * 'l) list -> 'j list -> 'k;
      build_R : 'd -> 'i; build_RBin : 'd -> 'l -> 'p -> 'l -> 'm;
      build_RComp : 'd -> 'l -> 'v -> 'l -> 'k; build_REq : 'd -> 'v;
      build_RIte : 'd -> 'j -> 'l -> 'l -> 'm; build_RLone : 'd -> 'w;
      build_RNEq : 'd -> 'v; build_RNo : 'd -> 'w; build_ROne : 
                                                     'd -> 'w; build_RProj : 'd -> 'p; build_RSome : 'd -> 'w;
      build_RTClos : 'd -> 'x; build_RUn : 'd -> 'x -> 'l -> 'm;
      build_Run : 'd -> 'j list -> 'y; build_S : 'd -> 'i;
      build_Some_ : 'd -> 'h; build_Sub : 'd -> 'g;
      build_TClos : 'd -> 'x; build_Transpose : 'd -> 'x;
      build_True : 'd -> 'k; build_U : 'd -> 'i; build_Union : 
                                                   'd -> 'p; build_Univ : 'd -> 'm; build_X : 'd -> 'q;
      build_exp : 'd -> 'm -> Location.t -> int option -> 'l;
      build_fml : 'd -> 'k -> Location.t -> 'j;
      build_iexp : 'd -> 'n -> Location.t -> 's;
      visit_'i : 'd -> 'z -> 'u; visit_'v : 'd -> 'a1 -> 'o;
      visit_Add : 'd -> 'g; visit_All : 'd -> 'h; visit_And : 'd -> 'i;
      visit_Block : 'd -> ('a1, 'z) block -> 'k;
      visit_BoxJoin : 'd -> ('a1, 'z) exp -> ('a1, 'z) exp list -> 'm;
      visit_Card : 'd -> ('a1, 'z) exp -> 'n;
      visit_Compr : 'd ->
      ('a1, 'z) sim_binding list -> ('a1, 'z) block -> 'm;
      visit_Diff : 'd -> 'p; visit_F : 'd -> 'q;
      visit_FIte : 'd ->
      ('a1, 'z) fml -> ('a1, 'z) fml -> ('a1, 'z) fml -> 'k;
      visit_False : 'd -> 'k; visit_G : 'd -> 'q; visit_Gt : 'd -> 'r;
      visit_Gte : 'd -> 'r; visit_H : 'd -> 'q;
      visit_IBin : 'd -> ('a1, 'z) iexp -> ibinop -> ('a1, 'z) iexp -> 'n;
      visit_IComp : 'd ->
      ('a1, 'z) iexp -> icomp_op -> ('a1, 'z) iexp -> 'k;
      visit_IEq : 'd -> 'r; visit_INEq : 'd -> 'r;
      visit_IUn : 'd -> iunop -> ('a1, 'z) iexp -> 'n;
      visit_Iden : 'd -> 'm; visit_Ident : 'd -> 'z -> 'm;
      visit_Iff : 'd -> 'i; visit_Imp : 'd -> 'i; visit_In : 'd -> 'v;
      visit_Inter : 'd -> 'p; visit_Join : 'd -> 'p;
      visit_LBin : 'd -> ('a1, 'z) fml -> lbinop -> ('a1, 'z) fml -> 'k;
      visit_LProj : 'd -> 'p;
      visit_LUn : 'd -> lunop -> ('a1, 'z) fml -> 'k;
      visit_Let : 'd -> ('a1, 'z) binding list -> ('a1, 'z) block -> 'k;
      visit_Lone : 'd -> 'h; visit_Lt : 'd -> 'r; visit_Lte : 'd -> 'r;
      visit_Neg : 'd -> 't; visit_No : 'd -> 'h; visit_None_ : 
                                                   'd -> 'm; visit_Not : 'd -> 'q; visit_NotIn : 'd -> 'v;
      visit_Num : 'd -> int -> 'n; visit_O : 'd -> 'q;
      visit_One : 'd -> 'h; visit_Or : 'd -> 'i; visit_Over : 'd -> 'p;
      visit_P : 'd -> 'q; visit_Prime : 'd -> ('a1, 'z) exp -> 'm;
      visit_Prod : 'd -> 'p;
      visit_Qual : 'd -> rqualify -> ('a1, 'z) exp -> 'k;
      visit_Quant : 'd ->
      quant ->
      ('a1, 'z) sim_binding list -> ('a1, 'z) block -> 'k;
      visit_R : 'd -> 'i;
      visit_RBin : 'd -> ('a1, 'z) exp -> rbinop -> ('a1, 'z) exp -> 'm;
      visit_RComp : 'd -> ('a1, 'z) exp -> comp_op -> ('a1, 'z) exp -> 'k;
      visit_REq : 'd -> 'v;
      visit_RIte : 'd ->
      ('a1, 'z) fml -> ('a1, 'z) exp -> ('a1, 'z) exp -> 'm;
      visit_RLone : 'd -> 'w; visit_RNEq : 'd -> 'v;
      visit_RNo : 'd -> 'w; visit_ROne : 'd -> 'w;
      visit_RProj : 'd -> 'p; visit_RSome : 'd -> 'w;
      visit_RTClos : 'd -> 'x;
      visit_RUn : 'd -> runop -> ('a1, 'z) exp -> 'm;
      visit_Run : 'd -> ('a1, 'z) block -> 'y; visit_S : 'd -> 'i;
      visit_Some_ : 'd -> 'h; visit_Sub : 'd -> 'g;
      visit_TClos : 'd -> 'x; visit_Transpose : 'd -> 'x;
      visit_True : 'd -> 'k; visit_U : 'd -> 'i; visit_Union : 
                                                   'd -> 'p; visit_Univ : 'd -> 'm; visit_X : 'd -> 'q;
    ...
    method visit_H : 'd -> 'q
    method visit_IBin :
      'd -> ('a1, 'z) iexp -> ibinop -> ('a1, 'z) iexp -> 'n
    method visit_IComp :
    ...
    method visit_LBin :
      'd -> ('a1, 'z) fml -> lbinop -> ('a1, 'z) fml -> 'k
    method visit_LProj : 'd -> 'p
    method visit_LUn : 'd -> lunop -> ('a1, 'z) fml -> 'k
    method visit_Let :
      'd -> ('a1, 'z) binding list -> ('a1, 'z) block -> 'k
    ...
    method visit_R : 'd -> 'i
    method visit_RBin :
      'd -> ('a1, 'z) exp -> rbinop -> ('a1, 'z) exp -> 'm
    method visit_RComp :
      'd -> ('a1, 'z) exp -> comp_op -> ('a1, 'z) exp -> 'k
...
val fite :
  ('a, 'b) fml -> ('a, 'b) fml -> ('a, 'b) fml -> ('a, 'b) prim_fml
...
val rite :
  ('a, 'b) fml -> ('a, 'b) exp -> ('a, 'b) exp -> ('a, 'b) prim_exp
val boxjoin : ('a, 'b) exp -> ('a, 'b) exp list -> ('a, 'b) prim_exp
val compr :
  ('a, 'b) sim_binding list -> ('a, 'b) block -> ('a, 'b) prim_exp
...
val ibinary :
  ('a, 'b) iexp -> ibinop -> ('a, 'b) iexp -> ('a, 'b) prim_iexp
val neg : iunop
val add : ibinop
val sub : ibinop
...
val pp_prim_fml :
  'a Fmtc.t ->
  (Format.formatter -> 'b -> unit) ->
  Format.formatter -> ('a, 'b) prim_fml -> unit
val pp_block :
...
val pp_binding :
  sep:unit Fmtc.t ->
  'a Fmtc.t -> (Format.formatter -> 'b -> unit) -> ('a, 'b) binding Fmtc.t
val pp_sim_binding :
  'a Fmtc.t ->
  (Format.formatter -> 'b -> unit) -> ('a, 'b) sim_binding Fmtc.t
val pp_exp :
  ?show_arity:disj ->
  'a Fmtc.t -> (Format.formatter -> 'b -> unit) -> ('a, 'b) exp Fmtc.t
val pp_prim_exp :
  'a Fmtc.t ->
  (Format.formatter -> 'b -> unit) ->
  Format.formatter -> ('a, 'b) prim_exp -> unit
val pp_runop : Format.formatter -> runop -> unit
val pp_rbinop : Format.formatter -> rbinop -> unit
val pp_iexp :
  'a Fmtc.t ->
  (Format.formatter -> 'b -> unit) ->
  Format.formatter -> ('a, 'b) iexp -> unit
val pp_prim_iexp :
  'a Fmtc.t ->
  (Format.formatter -> 'b -> unit) ->
  Format.formatter -> ('a, 'b) prim_iexp -> unit
