...
external compare : t -> t -> int = "camlidl_environment_ap_environment_compare"
(** Compare two environment. [compare env1 env2] return [-2] if the
    ...
    environements), [-1] if [env1] is a subset of env2, [0] if equality, [+1] if
    env1 is a superset of env2, and [+2] otherwise (the lce exists and is a
