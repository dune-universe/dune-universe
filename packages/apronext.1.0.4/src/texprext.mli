...
(* This file is part of the APRON Library, released under LGPL license with an
   exception allowing the redistribution of statically linked executables.
   Please read the COPYING file packaged in the distribution *)
(* File generated from texpr1.idl *)

type t = Texpr1.t = {mutable texpr0: Texpr0.t; mutable env: Environment.t}
...
(** Binary operators *)
type binop = Texpr0.binop = Add | Sub | Mul | Div | Mod | Pow
...
external cst : Environment.t -> Coeff.t -> t = "camlidl_texpr1_ap_texpr1_cst"
...
(** Change the environment of the expression for a super-environment. Raise
