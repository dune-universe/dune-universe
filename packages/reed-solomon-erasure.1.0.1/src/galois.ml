...
let reedsolomon_gal_mul =
  foreign "reedsolomon_gal_mul" (ptr uint8_t @-> ptr uint8_t @-> ptr uint8_t @-> ptr uint8_t @-> size_t @-> returning size_t)

let reedsolomon_gal_mul_xor =
  foreign "reedsolomon_gal_mul_xor" (ptr uint8_t @-> ptr uint8_t @-> ptr uint8_t @-> ptr uint8_t @-> size_t @-> returning size_t)
