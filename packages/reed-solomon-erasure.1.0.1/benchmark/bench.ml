...
let benchmark_encode_bigstr
  ...
  Printf.printf "    MB/s             : %f\n" ((float_of_int byte_count) /. 1_000_000.0 /. time_taken)
...
let () =
  benchmark_encode_bigstr 100 10 2 1_000_000;
  benchmark_encode_bytes  100 10 2 1_000_000;
  benchmark_encode_str    100 10 2 1_000_000;
