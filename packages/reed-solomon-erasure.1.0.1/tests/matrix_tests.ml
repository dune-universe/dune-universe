...
let test_matrix_col_count test_ctxt =
...
let test_matrix_swap_rows test_ctxt =
  begin
...
let test_inconsistent_row_sizes test_ctxt =
  try
...
let test_incompatible_multiply test_ctxt =
  try
...
let test_incompatible_augment test_ctxt =
  try
...
let test_matrix_identity test_ctxt =
...
let test_matrix_multiply test_ctxt =
