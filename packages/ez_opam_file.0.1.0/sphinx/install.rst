...
If :code:`ez_opam_file` is available in your opam repository, you can just call::

  opam install ez_opam_file

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`ez_opam_file` in a directory.
