...
# -*- coding: utf-8 -*-
#
# ez_subst documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ez_subst.tex', 'ez_subst Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ez_subst', 'ez_subst Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ez_subst', 'ez_subst Documentation',
     author, 'ez_subst', 'One line description of project.',
     'Miscellaneous'),
]
