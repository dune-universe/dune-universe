...
let invalid_commit cfile =
  "Failed to parse commitment box from file " ^ cfile
  ^ "! It's possibly an invalid file..."

let invalid_open ofile =
  "Failed to parse opening key from file " ^ ofile
  ^ "! It's possibly an invalid file..."

let invalid_pairs cfile ofile =
  "Failed to reveal the secret from both commitment file " ^ cfile
  ^ " and opening file" ^ ofile
