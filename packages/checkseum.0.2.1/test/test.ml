    ...
    [
      ( "crc32c",
        [
          ...
          make ~name:"2"
            (module Checkseum.Crc32c)
            "\xff\xff\xff\xff"
            (Optint.of_int32 0xffffffffl);
          make ~name:"3"
            (module Checkseum.Crc32c)
            "123456789"
            (Optint.of_int32 0xe3069283l);
          make ~name:"4"
            (module Checkseum.Crc32c)
      ...
      ( "crc24",
        [
          ...
          make ~name:"2" (module Checkseum.Crc24) "abc" (Optint.of_int 0xba1c7b);
          make ~name:"3"
            (module Checkseum.Crc24)
            "message digest" (Optint.of_int 0xdbf0b6);
        ] );
    ]
