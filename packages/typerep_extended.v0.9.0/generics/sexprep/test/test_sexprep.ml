...
let%test_module _ = (module struct
  ...
  let%test_unit _ =
    let module M = struct
      type t = int [@@deriving typerep, sexp]
    end in
    let value = 5 in
  ...
  let%test_unit _ =
    let module M = struct
      type t = int32 [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type t = int64 [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type t = char [@@deriving typerep, sexp]
    end in
    let value = 'c' in
    assert(check value M.typerep_of_t);
    assert(check_of_sexp value M.typerep_of_t M.sexp_of_t);
  ...
  let%test_unit _ =
    let module M = struct
      type t = float [@@deriving typerep, sexp]
    end in
    let value = 543.02 in
    assert(check value M.typerep_of_t);
    assert(check_of_sexp value M.typerep_of_t M.sexp_of_t);
  ...
  let%test_unit _ =
    let module M = struct
      type t = string [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type t = bool [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type t = unit [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type 'a t = 'a option [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type 'a t = 'a list [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type 'a t = 'a array [@@deriving typerep, sexp]
    end in
    assert(check [||] (M.typerep_of_t typerep_of_int));
    assert(check [|1;2;6;5;4;3|] (M.typerep_of_t typerep_of_int));
  ...
  let%test_unit _ =
    let module M = struct
      type 'a t = 'a ref [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type 'a t = 'a lazy_t [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type 'a t = {foo:'a; bar:float} [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type ('a, 'b) t = ('a * 'b) [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type ('a, 'b, 'c) t = ('a * 'b * 'c) [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type ('a, 'b, 'c, 'd) t = ('a * 'b * 'c * 'd) [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type ('a, 'b, 'c, 'd, 'e) t = ('a * 'b * 'c * 'd * 'e) [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type 'a t =
        ...
        | Bax of (int * int)
        | Baa of 'a * 'a
        | Bab of ('a * 'a) [@@deriving typerep, sexp]
    end in
  ...
  let%test_unit _ =
    let module M = struct
      type t = Leaf | Node of t * t [@@deriving typerep, sexp]
    end in
    let rec producer n =
      if n > 0
  ...
  let%test_unit _ =
    let module M = struct
      type 'a t = [ `Foo | `Bar of 'a ] [@@deriving typerep]
    end in
  ...
  module Rev_option : sig
    ...
    module T = struct
      type 'a t = 'a option [@@deriving typerep ~abstract]
    end
    include T
  ...
  let%test_unit _ =
    let module A = struct
      type t = int Rev_option.t [@@deriving typerep]
    end in
    assert (
      try
  ...
  let%test_unit _ =
    let module Rev_int : sig
      ...
      exception Parse_error of Sexp.t [@@deriving sexp]
