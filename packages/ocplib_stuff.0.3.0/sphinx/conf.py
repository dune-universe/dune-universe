...
# -*- coding: utf-8 -*-
#
# ocplib_stuff documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ocplib_stuff.tex', 'ocplib_stuff Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ocplib_stuff', 'ocplib_stuff Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ocplib_stuff', 'ocplib_stuff Documentation',
     author, 'ocplib_stuff', 'One line description of project.',
     'Miscellaneous'),
]
