...
If :code:`ocplib_stuff` is available in your opam repository, you can just call::

  opam install ocplib_stuff

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`ocplib_stuff` in a directory.
