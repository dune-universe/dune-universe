      ...
      double precision function lbfgs_dnrm2(n,x,incx)
      integer n,incx
...
c     **********
   ...
   10 continue
      ...
      do 20 i = 1, n, incx
         lbfgs_dnrm2 = lbfgs_dnrm2 + (x(i)/scale)**2
   20 continue

      lbfgs_dnrm2 = scale*sqrt(lbfgs_dnrm2)
...
c====================== The end of daxpy ===============================
      ...
      subroutine lbfgs_dcopy(n,dx,incx,dy,incy)
c
...
c====================== The end of ddot ================================
      ...
      subroutine  lbfgs_dscal(n,da,dx,incx)
c
