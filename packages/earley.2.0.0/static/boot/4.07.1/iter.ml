...
and iter_row_field c1 =
  match c1 with
  | Rtag(x1,x2,x3,x4) -> () ; ((iter_loc iter_label) x1) ; (iter_attributes x2) ; ((fun _ -> ()) x3) ; ((iter_list iter_core_type) x4)  | Rinherit(x) -> iter_core_type x

and iter_object_field c1 =
  match c1 with
  | Otag(x1,x2,x3) -> () ; ((iter_loc iter_label) x1) ; (iter_attributes x2) ; (iter_core_type x3)  | Oinherit(x) -> iter_core_type x
...
and iter_class_type_desc c1 =
  ...
  | Pcty_open(x1,x2,x3) -> () ; (iter_override_flag x1) ; ((iter_loc iter_longident) x2) ; (iter_class_type x3)
...
and iter_class_type_field_desc c1 =
  ...
  | Pctf_val(x1,x2,x3,x4) -> () ; ((iter_loc iter_label) x1) ; (iter_mutable_flag x2) ; (iter_virtual_flag x3) ; (iter_core_type x4)  | Pctf_method(x1,x2,x3,x4) -> () ; ((iter_loc iter_label) x1) ; (iter_private_flag x2) ; (iter_virtual_flag x3) ; (iter_core_type x4)  | Pctf_constraint(x1,x2) -> () ; (iter_core_type x1) ; (iter_core_type x2)  | Pctf_attribute(x) -> iter_attribute x
...
and iter_class_expr_desc c1 =
  ...
  | Pcl_open(x1,x2,x3) -> () ; (iter_override_flag x1) ; ((iter_loc iter_longident) x2) ; (iter_class_expr x3)
...
and iter_with_constraint c1 =
  match c1 with
  | Pwith_type(x1,x2) -> () ; ((iter_loc iter_longident) x1) ; (iter_type_declaration x2)  | Pwith_module(x1,x2) -> () ; ((iter_loc iter_longident) x1) ; ((iter_loc iter_longident) x2)  | Pwith_typesubst(x1,x2) -> () ; ((iter_loc iter_longident) x1) ; (iter_type_declaration x2)  | Pwith_modsubst(x1,x2) -> () ; ((iter_loc iter_longident) x1) ; ((iter_loc iter_longident) x2)
