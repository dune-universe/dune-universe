...
val polymarker : int -> float Ctypes_static.ptr -> float Ctypes_static.ptr -> unit
...
val hexbin : int -> float Ctypes_static.ptr -> float Ctypes_static.ptr -> int -> int
...
val get_size_and_pointer : ('a, 'b, 'c) Bigarray.Genarray.t -> int * 'a Ctypes.ptr
