...
let gdp =
  foreign
    "gr_gdp"
    (int @-> ptr double @-> ptr double @-> int @-> int @-> ptr int @-> returning void)
...
let setcolorrep =
  foreign "gr_setcolorrep" (int @-> double @-> double @-> double @-> returning void)


let setwindow =
  foreign "gr_setwindow" (double @-> double @-> double @-> double @-> returning void)
...
let setviewport =
  foreign "gr_setviewport" (double @-> double @-> double @-> double @-> returning void)
...
let setwswindow =
  foreign "gr_setwswindow" (double @-> double @-> double @-> double @-> returning void)


let setwsviewport =
  foreign "gr_setwsviewport" (double @-> double @-> double @-> double @-> returning void)
...
let inqtextext =
  foreign
    "gr_inqtextext"
    (double @-> double @-> string @-> ptr double @-> ptr double @-> returning void)
...
let verrorbars =
  foreign
    "gr_verrorbars"
    (int @-> ptr double @-> ptr double @-> ptr double @-> ptr double @-> returning void)
...
let surface =
  foreign
    "gr_surface"
    (int @-> int @-> ptr double @-> ptr double @-> ptr double @-> int @-> returning void)
...
let hexbin =
  foreign "gr_hexbin" (int @-> ptr double @-> ptr double @-> int @-> returning int)
...
let beginprintext =
  foreign "gr_beginprintext" (string @-> string @-> string @-> string @-> returning void)
...
let wc3towc =
  foreign "gr_wc3towc" (ptr double @-> ptr double @-> ptr double @-> returning void)


let drawrect =
  foreign "gr_drawrect" (double @-> double @-> double @-> double @-> returning void)


let fillrect =
  foreign "gr_fillrect" (double @-> double @-> double @-> double @-> returning void)
...
let drawpath =
  foreign "gr_drawpath" (int @-> ptr vertex @-> ptr uchar @-> int @-> returning void)
...
let drawarrow =
  foreign "gr_drawarrow" (double @-> double @-> double @-> double @-> returning void)
...
let delaunay =
  foreign
    "gr_delaunay"
    (int @-> ptr double @-> ptr double @-> ptr int @-> ptr (ptr int) @-> returning void)
...
let shadepoints =
  foreign
    "gr_shadepoints"
    (int @-> ptr double @-> ptr double @-> int @-> int @-> int @-> returning void)
