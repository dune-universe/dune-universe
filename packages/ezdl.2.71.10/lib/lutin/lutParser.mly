...
lutNaryExp:
   /* n-ary */
   |  TK_DIESE TK_OPEN_PAR lutExpList TK_CLOSE_PAR
        { make_val_exp (CALL_n (flagit "#" $1, (List.rev $3))) $1 }
   |  TK_NOR TK_OPEN_PAR lutExpList TK_CLOSE_PAR
        { make_val_exp (CALL_n (flagit "nor" $1, (List.rev $3))) $1 }
   |  TK_XOR TK_OPEN_PAR lutExpList TK_CLOSE_PAR
        { make_val_exp (CALL_n (flagit "nxor" $1, (List.rev $3))) $1 }
   ;    
lutExpList:   
		/* empty */
        { [] }
