  ...
  functor (IO : Io_intf.S) ->
    sig
      ...
      val copy_nodemask_to_bitmask :
        nodemask:nodemask -> bitmask:bitmask -> unit IO.t
      val copy_bitmask_to_nodemask :
        bitmask:bitmask -> nodemask:nodemask -> unit IO.t
      val copy_bitmask_to_bitmask :
        srcmask:bitmask -> dstmask:bitmask -> unit IO.t
      ...
      val numa_migrate_pages :
        pid:int -> fromnodes:bitmask -> tonodes:bitmask -> int IO.t
