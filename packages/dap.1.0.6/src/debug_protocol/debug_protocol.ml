...
module Variable_presentation_hint = struct
  module Kind = struct
    ...
    let of_yojson = function
      ...
      | `String "data" -> Ok Data
      | `String "event" -> Ok Event
      | `String "baseClass" -> Ok Base_class
      | `String "innerClass" -> Ok Inner_class
  ...
  module Attributes = struct
    ...
    let of_yojson = function
      ...
      | `String "constant" -> Ok Constant
      | `String "readOnly" -> Ok Read_only
      | `String "rawString" -> Ok Raw_string
...
module Breakpoint_location = struct
...
module Data_breakpoint_access_type = struct
...
module Instruction_breakpoint = struct
...
module Stepping_granularity = struct
...
module Exception_filter_options = struct
...
module Disassembled_instruction = struct
...
module Invalidated_areas = struct
...
module Stopped_event = struct
  ...
  module Payload = struct
    module Reason = struct
      ...
      let of_yojson = function
        | `String "step" -> Ok Step
        | `String "breakpoint" -> Ok Breakpoint
        | `String "exception" -> Ok Exception
        | `String "pause" -> Ok Pause
        | `String "entry" -> Ok Entry
        | `String "goto" -> Ok Goto
