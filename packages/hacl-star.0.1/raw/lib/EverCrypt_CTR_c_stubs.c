                                 ...
                                 value x14, value x13)
{
   ...
   char* x23 = CTYPES_PTR_OF_OCAML_STRING(x16);
   char* x24 = CTYPES_PTR_OF_OCAML_STRING(x15);
                            ...
                            value x38)
{
   ...
   char* x44 = CTYPES_PTR_OF_OCAML_STRING(x41);
...
value _5_EverCrypt_CTR_update_block(value x55, value x54, value x53)
{
   ...
   char* x58 = CTYPES_PTR_OF_OCAML_STRING(x53);
