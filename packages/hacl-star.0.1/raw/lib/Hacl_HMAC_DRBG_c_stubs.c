                                    ...
                                    value x17, value x16)
{
   ...
   char* x33 = CTYPES_PTR_OF_OCAML_STRING(x20);
   uint32_t x34 = Uint32_val(x19);
   char* x37 = CTYPES_PTR_OF_OCAML_STRING(x18);
   uint32_t x38 = Uint32_val(x17);
   char* x41 = CTYPES_PTR_OF_OCAML_STRING(x16);
                               ...
                               value x52, value x51)
{
   ...
   char* x66 = CTYPES_PTR_OF_OCAML_STRING(x53);
   uint32_t x67 = Uint32_val(x52);
   char* x70 = CTYPES_PTR_OF_OCAML_STRING(x51);
                                  ...
                                  value x79, value x78)
{
   ...
   char* x87 = CTYPES_PTR_OF_OCAML_STRING(x82);
   ...
   char* x97 = CTYPES_PTR_OF_OCAML_STRING(x78);
