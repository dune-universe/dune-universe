...
external _1_EverCrypt_HMAC_compute_sha1
  ...
  = "_1_EverCrypt_HMAC_compute_sha1" 

external _2_EverCrypt_HMAC_compute_sha2_256
  : Bytes.t CI.ocaml -> Bytes.t CI.ocaml -> Unsigned.uint32 ->
    Bytes.t CI.ocaml -> Unsigned.uint32 -> unit
  = "_2_EverCrypt_HMAC_compute_sha2_256" 

external _3_EverCrypt_HMAC_compute_sha2_384
  : Bytes.t CI.ocaml -> Bytes.t CI.ocaml -> Unsigned.uint32 ->
    Bytes.t CI.ocaml -> Unsigned.uint32 -> unit
  = "_3_EverCrypt_HMAC_compute_sha2_384" 

external _4_EverCrypt_HMAC_compute_sha2_512
  : Bytes.t CI.ocaml -> Bytes.t CI.ocaml -> Unsigned.uint32 ->
    Bytes.t CI.ocaml -> Unsigned.uint32 -> unit
  = "_4_EverCrypt_HMAC_compute_sha2_512" 
...
| Function
  ...
  (fun x1 x4 x5 x6 x7 x8 ->
    let x3 = x2 x1 in _6_EverCrypt_HMAC_compute x3 x4 x5 x6 x7 x8)
| Function
