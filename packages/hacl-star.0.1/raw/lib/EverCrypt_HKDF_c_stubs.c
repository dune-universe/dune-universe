...
{
   char* x47 = CTYPES_PTR_OF_OCAML_STRING(x46);
   char* x48 = CTYPES_PTR_OF_OCAML_STRING(x45);
   uint32_t x49 = Uint32_val(x44);
   char* x52 = CTYPES_PTR_OF_OCAML_STRING(x43);
...
value _4_EverCrypt_HKDF_extract_sha2_256(value x70, value x69, value x68,
                                         value x67, value x66)
{
   char* x71 = CTYPES_PTR_OF_OCAML_STRING(x70);
   char* x72 = CTYPES_PTR_OF_OCAML_STRING(x69);
   uint32_t x73 = Uint32_val(x68);
   char* x76 = CTYPES_PTR_OF_OCAML_STRING(x67);
                                        ...
                                        value x83, value x82, value x81)
{
   ...
   char* x88 = CTYPES_PTR_OF_OCAML_STRING(x85);
   uint32_t x89 = Uint32_val(x84);
   char* x92 = CTYPES_PTR_OF_OCAML_STRING(x83);
...
{
   char* x111 = CTYPES_PTR_OF_OCAML_STRING(x110);
   char* x112 = CTYPES_PTR_OF_OCAML_STRING(x109);
   uint32_t x113 = Uint32_val(x108);
   char* x116 = CTYPES_PTR_OF_OCAML_STRING(x107);
                                        ...
                                        value x123, value x122, value x121)
{
   ...
   char* x132 = CTYPES_PTR_OF_OCAML_STRING(x123);
...
{
   char* x151 = CTYPES_PTR_OF_OCAML_STRING(x150);
   char* x152 = CTYPES_PTR_OF_OCAML_STRING(x149);
   uint32_t x153 = Uint32_val(x148);
   char* x156 = CTYPES_PTR_OF_OCAML_STRING(x147);
                               ...
                               value x161)
{
   ...
   char* x171 = CTYPES_PTR_OF_OCAML_STRING(x166);
   char* x172 = CTYPES_PTR_OF_OCAML_STRING(x165);
   uint32_t x173 = Uint32_val(x164);
   char* x176 = CTYPES_PTR_OF_OCAML_STRING(x163);
                                 ...
                                 value x193, value x192, value x191)
{
   ...
   char* x200 = CTYPES_PTR_OF_OCAML_STRING(x195);
   char* x201 = CTYPES_PTR_OF_OCAML_STRING(x194);
   uint32_t x202 = Uint32_val(x193);
   char* x205 = CTYPES_PTR_OF_OCAML_STRING(x192);
                                     ...
                                     value x216)
{
   ...
   char* x226 = CTYPES_PTR_OF_OCAML_STRING(x221);
   char* x227 = CTYPES_PTR_OF_OCAML_STRING(x220);
   uint32_t x228 = Uint32_val(x219);
   char* x231 = CTYPES_PTR_OF_OCAML_STRING(x218);
                                      ...
                                      value x248, value x247, value x246)
{
   ...
   char* x255 = CTYPES_PTR_OF_OCAML_STRING(x250);
   char* x256 = CTYPES_PTR_OF_OCAML_STRING(x249);
   uint32_t x257 = Uint32_val(x248);
   char* x260 = CTYPES_PTR_OF_OCAML_STRING(x247);
