                                          ...
                                          value x1)
{
   ...
   char* x7 = CTYPES_PTR_OF_OCAML_STRING(x2);
                                            ...
                                            value x23)
{
   ...
   char* x31 = CTYPES_PTR_OF_OCAML_STRING(x24);
   char* x32 = CTYPES_PTR_OF_OCAML_STRING(x23);
                                        ...
                                        value x36, value x35, value x34)
{
   ...
   char* x43 = CTYPES_PTR_OF_OCAML_STRING(x38);
   char* x44 = CTYPES_PTR_OF_OCAML_STRING(x37);
   char* x45 = CTYPES_PTR_OF_OCAML_STRING(x36);
   char* x46 = CTYPES_PTR_OF_OCAML_STRING(x35);
                                        ...
                                        value x59, value x58, value x57)
{
   ...
   char* x66 = CTYPES_PTR_OF_OCAML_STRING(x61);
   char* x67 = CTYPES_PTR_OF_OCAML_STRING(x60);
   char* x68 = CTYPES_PTR_OF_OCAML_STRING(x59);
   char* x69 = CTYPES_PTR_OF_OCAML_STRING(x58);
