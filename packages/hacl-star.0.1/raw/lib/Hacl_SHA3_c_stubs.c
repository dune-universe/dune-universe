...
value _3_Hacl_Impl_SHA3_loadState(value x15, value x14, value x13)
{
   ...
   char* x19 = CTYPES_PTR_OF_OCAML_STRING(x14);
...
value _4_Hacl_Impl_SHA3_storeState(value x24, value x23, value x22)
{
   ...
   char* x29 = CTYPES_PTR_OF_OCAML_STRING(x22);
                               ...
                               value x31)
{
   ...
   char* x43 = CTYPES_PTR_OF_OCAML_STRING(x32);
...
value _6_Hacl_Impl_SHA3_squeeze(value x51, value x50, value x49, value x48)
{
   ...
   char* x59 = CTYPES_PTR_OF_OCAML_STRING(x48);
                               ...
                               value x63, value x62, value x61)
{
   ...
   char* x77 = CTYPES_PTR_OF_OCAML_STRING(x64);
   uint8_t x78 = Uint8_val(x63);
   uint32_t x81 = Uint32_val(x62);
   char* x84 = CTYPES_PTR_OF_OCAML_STRING(x61);
...
value _8_Hacl_SHA3_shake128_hacl(value x96, value x95, value x94, value x93)
{
   ...
   char* x104 = CTYPES_PTR_OF_OCAML_STRING(x93);
                                 ...
                                 value x106)
{
   ...
   char* x113 = CTYPES_PTR_OF_OCAML_STRING(x108);
   uint32_t x114 = Uint32_val(x107);
   char* x117 = CTYPES_PTR_OF_OCAML_STRING(x106);
...
value _10_Hacl_SHA3_sha3_224(value x121, value x120, value x119)
{
   ...
   char* x125 = CTYPES_PTR_OF_OCAML_STRING(x120);
   char* x126 = CTYPES_PTR_OF_OCAML_STRING(x119);
...
value _11_Hacl_SHA3_sha3_256(value x130, value x129, value x128)
{
   ...
   char* x134 = CTYPES_PTR_OF_OCAML_STRING(x129);
   char* x135 = CTYPES_PTR_OF_OCAML_STRING(x128);
...
value _12_Hacl_SHA3_sha3_384(value x139, value x138, value x137)
{
   ...
   char* x143 = CTYPES_PTR_OF_OCAML_STRING(x138);
   char* x144 = CTYPES_PTR_OF_OCAML_STRING(x137);
...
value _13_Hacl_SHA3_sha3_512(value x148, value x147, value x146)
{
   ...
   char* x152 = CTYPES_PTR_OF_OCAML_STRING(x147);
   char* x153 = CTYPES_PTR_OF_OCAML_STRING(x146);
