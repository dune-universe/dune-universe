...
{
   char* x2 = CTYPES_PTR_OF_OCAML_STRING(x1);
   struct Hacl_Streaming_Functor_state_s___uint64_t___uint8_t__s* x3 =
...
value _2_Hacl_Streaming_Poly1305_32_init(value x5, value x4)
{
   ...
   struct Hacl_Streaming_Functor_state_s___uint64_t___uint8_t__s* x7 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t___uint8_t__s* x12 =
   CTYPES_ADDR_OF_FATPTR(x11);
   char* x13 = CTYPES_PTR_OF_OCAML_STRING(x10);
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t___uint8_t__s* x20 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t___uint8_t__s* x24 =
