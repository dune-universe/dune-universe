...
# ones.
#extensions = ['sphinx.ext.extlinks', 'tryliquidity']
...
project = 'opam-bin'
copyright = '2020, OCamlPro & Origin Labs SAS. <contact@ocamlpro.com>'
author = 'OCamlPro & Origin Labs SAS. <contact@origin-labs.com>'
...
latex_documents = [
    (master_doc, 'opam-bin.tex', 'Opam-bin Documentation',
     'OCamlPro and Origin Labs SAS', 'manual'),
]
...
man_pages = [
    (master_doc, 'opam-bin', 'Opam-bin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'opam-bin', 'Opam-bin Documentation',
     author, 'opam-bin', 'One line description of project.',
     'Miscellaneous'),
]
