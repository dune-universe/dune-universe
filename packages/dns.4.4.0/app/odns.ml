...
let cmd_a : unit Term.t * Term.info =
  ...
  Term.info "a" ~version:(Manpage.escape "v4.4.0") ~man ~doc ~sdocs
...
let cmd_aaaa : unit Term.t * Term.info =
  ...
  Term.info "aaaa" ~version:(Manpage.escape "v4.4.0") ~man ~doc ~sdocs
...
let cmd_mx : unit Term.t * Term.info =
  ...
  Term.info "mx" ~version:(Manpage.escape "v4.4.0") ~man ~doc ~sdocs
...
let cmd_tlsa : unit Term.t * Term.info =
  ...
  Term.info "tlsa" ~version:(Manpage.escape "v4.4.0") ~man ~doc ~sdocs
...
let cmd_txt : unit Term.t * Term.info =
  ...
  Term.info "txt" ~version:(Manpage.escape "v4.4.0") ~man ~doc ~sdocs
...
let cmd_any : unit Term.t * Term.info =
  ...
  Term.info "any" ~version:(Manpage.escape "v4.4.0") ~man ~doc ~sdocs
...
let cmd_dkim : unit Term.t * Term.info =
  ...
  Term.info "dkim" ~version:(Manpage.escape "v4.4.0") ~man ~doc ~sdocs
...
|}
  ...
  Term.info "odns" ~version:(Manpage.escape "v4.4.0") ~man ~doc ~sdocs
