...
(**[^?>] is the nondeterministic arrow combinator. [spec1 ^?> spec2] is a
   ...
   The (de)constructibility constraints are stricter than those imposed
   by an ordinary arrow [(^>)]. The domain must be constructible and
...
(*  LocalWords:  well-formedness Gen.closed_interval *)
