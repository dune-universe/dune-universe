...
(* This is a copy of ptmap.ml, taken from ptmap 2.0.5.
   Commit is b18f4c325019ed1e4e692ae71cd337621982b482.
   This copy has been modified by re-introducing the
   bug discovered by Jan Midtgaard, which is to use
   a signed comparison instead of unsigned comparison.
   Search for BUG. *)
