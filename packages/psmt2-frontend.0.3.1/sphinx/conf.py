...
# -*- coding: utf-8 -*-
#
# psmt2-frontend documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'psmt2-frontend'
copyright = 'Albin Coquereau'
author = 'Albin Coquereau'
...
latex_documents = [
    (master_doc, 'psmt2-frontend.tex', 'psmt2-frontend Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'psmt2-frontend', 'psmt2-frontend Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'psmt2-frontend', 'psmt2-frontend Documentation',
     author, 'psmt2-frontend', 'One line description of project.',
     'Miscellaneous'),
]
