...
include Generic.IteratorsInit(struct
  ...
  module Iter = Iter
  module UncheckedIter = UncheckedIter
end)
...
(* This validity check is required by [Generic.IteratorsInit]. *)

let[@inline] is_valid _it =
  true

(* This phony write operation is required by [Generic.IteratorsInit]. *)
