...
{
   struct Hacl_Streaming_Functor_state_s___uint32_t_____s* x24 =
   Hacl_Streaming_SHA2_create_in_256();
   return CTYPES_FROM_PTR(x24);
}
value _7_Hacl_Streaming_SHA2_init_256(value x25)
{
   struct Hacl_Streaming_Functor_state_s___uint32_t_____s* x26 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint32_t_____s* x31 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint32_t_____s* x39 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint32_t_____s* x43 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x46 =
   Hacl_Streaming_SHA2_create_in_384();
   return CTYPES_FROM_PTR(x46);
}
value _12_Hacl_Streaming_SHA2_init_384(value x47)
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x48 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x53 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x61 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x65 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x68 =
   Hacl_Streaming_SHA2_create_in_512();
   return CTYPES_FROM_PTR(x68);
}
value _17_Hacl_Streaming_SHA2_init_512(value x69)
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x70 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x75 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x83 =
...
{
   struct Hacl_Streaming_Functor_state_s___uint64_t_____s* x87 =
