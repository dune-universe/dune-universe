                                        ...
                                        value x32, value x31)
{
   ...
   uint64_t x43 = Hacl_P256_ecdsa_sign_p256_sha2(x36, x37, x40, x41, x42);
                                          ...
                                          value x45, value x44)
{
   ...
   uint64_t x56 = Hacl_P256_ecdsa_sign_p256_sha384(x49, x50, x53, x54, x55);
   return integers_copy_uint64(x56);
}
                                          ...
                                          value x58, value x57)
{
   ...
   uint64_t x69 = Hacl_P256_ecdsa_sign_p256_sha512(x62, x63, x66, x67, x68);
   return integers_copy_uint64(x69);
}
                                                 ...
                                                 value x70)
{
   ...
   return integers_copy_uint64(x82);
}
...
value _20_Hacl_P256_reduction_8_32(value x159, value x158)
{
   unsigned char* x160 = CTYPES_PTR_OF_OCAML_BYTES(x159);
   unsigned char* x161 = CTYPES_PTR_OF_OCAML_BYTES(x158);
   Hacl_P256_reduction_8_32(x160, x161);
   return Val_unit;
}
value _21_Hacl_P256_ecp256dh_i(value x164, value x163)
{
   unsigned char* x165 = CTYPES_PTR_OF_OCAML_BYTES(x164);
   unsigned char* x166 = CTYPES_PTR_OF_OCAML_BYTES(x163);
   uint64_t x167 = Hacl_P256_ecp256dh_i(x165, x166);
   return integers_copy_uint64(x167);
}
value _22_Hacl_P256_ecp256dh_r(value x170, value x169, value x168)
{
   ...
   uint64_t x174 = Hacl_P256_ecp256dh_r(x171, x172, x173);
   return integers_copy_uint64(x174);
}
