...
value _1_Hacl_Chacha20Poly1305_32_aead_encrypt(value x8, value x7, value x6,
                                               ...
                                               value x2, value x1)
{
   ...
   Hacl_Chacha20Poly1305_32_aead_encrypt(x9, x10, x11, x14, x15, x18, 
                                         x19, x20);
   return Val_unit;
}
value _1_Hacl_Chacha20Poly1305_32_aead_encrypt_byte8(value* argv, int argc)
{
   value x22 = argv[7];
   value x23 = argv[6];
   value x24 = argv[5];
   ...
   value x29 = argv[0];
   return
     _1_Hacl_Chacha20Poly1305_32_aead_encrypt(x29, x28, x27, x26, x25, 
                                              x24, x23, x22);
}
value _2_Hacl_Chacha20Poly1305_32_aead_decrypt(value x37, value x36,
                                               value x35, value x34,
                                               value x33, value x32,
                                               value x31, value x30)
{
   ...
   uint32_t x50 =
   Hacl_Chacha20Poly1305_32_aead_decrypt(x38, x39, x40, x43, x44, x47, 
                                         x48, x49);
   return integers_copy_uint32(x50);
}
value _2_Hacl_Chacha20Poly1305_32_aead_decrypt_byte8(value* argv, int argc)
{
   value x51 = argv[7];
   value x52 = argv[6];
   value x53 = argv[5];
   ...
   value x58 = argv[0];
   return
     _2_Hacl_Chacha20Poly1305_32_aead_decrypt(x58, x57, x56, x55, x54, 
                                              x53, x52, x51);
}
