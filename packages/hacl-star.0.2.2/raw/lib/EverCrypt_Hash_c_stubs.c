...
value _19_EverCrypt_Hash_Incremental_create_in(value x141)
{
   uint8_t x142 = Uint8_val(x141);
   struct Hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_____s* x145
   = EverCrypt_Hash_Incremental_create_in(x142);
   return CTYPES_FROM_PTR(x145);
}
value _20_EverCrypt_Hash_Incremental_init(value x146)
{
   struct Hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_____s* x147
   = CTYPES_ADDR_OF_FATPTR(x146);
   EverCrypt_Hash_Incremental_init(x147);
   return Val_unit;
}
value _21_EverCrypt_Hash_Incremental_update(value x151, value x150,
                                            value x149)
{
   struct Hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_____s* x152
   = CTYPES_ADDR_OF_FATPTR(x151);
   unsigned char* x153 = CTYPES_PTR_OF_OCAML_BYTES(x150);
   uint32_t x154 = Uint32_val(x149);
   EverCrypt_Hash_Incremental_update(x152, x153, x154);
   return Val_unit;
}
value _22_EverCrypt_Hash_Incremental_finish_md5(value x159, value x158)
{
   struct Hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_____s* x160
   = CTYPES_ADDR_OF_FATPTR(x159);
   unsigned char* x161 = CTYPES_PTR_OF_OCAML_BYTES(x158);
   EverCrypt_Hash_Incremental_finish_md5(x160, x161);
   return Val_unit;
}
value _23_EverCrypt_Hash_Incremental_finish_sha1(value x164, value x163)
{
   struct Hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_____s* x165
   = CTYPES_ADDR_OF_FATPTR(x164);
   unsigned char* x166 = CTYPES_PTR_OF_OCAML_BYTES(x163);
   EverCrypt_Hash_Incremental_finish_sha1(x165, x166);
   return Val_unit;
}
value _24_EverCrypt_Hash_Incremental_finish_sha224(value x169, value x168)
{
   ...
   EverCrypt_Hash_Incremental_finish_sha224(x170, x171);
   return Val_unit;
}
value _25_EverCrypt_Hash_Incremental_finish_sha256(value x174, value x173)
{
   ...
   EverCrypt_Hash_Incremental_finish_sha256(x175, x176);
   return Val_unit;
}
value _26_EverCrypt_Hash_Incremental_finish_sha384(value x179, value x178)
{
   ...
   EverCrypt_Hash_Incremental_finish_sha384(x180, x181);
   return Val_unit;
}
value _27_EverCrypt_Hash_Incremental_finish_sha512(value x184, value x183)
{
   ...
   EverCrypt_Hash_Incremental_finish_sha512(x185, x186);
   return Val_unit;
}
value _28_EverCrypt_Hash_Incremental_finish_blake2s(value x189, value x188)
{
   ...
   EverCrypt_Hash_Incremental_finish_blake2s(x190, x191);
   return Val_unit;
}
value _29_EverCrypt_Hash_Incremental_finish_blake2b(value x194, value x193)
{
   ...
   EverCrypt_Hash_Incremental_finish_blake2b(x195, x196);
   return Val_unit;
}
value _30_EverCrypt_Hash_Incremental_alg_of_state(value x198)
{
   struct Hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_____s* x199
   = CTYPES_ADDR_OF_FATPTR(x198);
   Spec_Hash_Definitions_hash_alg x200 =
   EverCrypt_Hash_Incremental_alg_of_state(x199);
   return Integers_val_uint8(x200);
}
value _31_EverCrypt_Hash_Incremental_finish(value x202, value x201)
{
   struct Hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_____s* x203
   = CTYPES_ADDR_OF_FATPTR(x202);
   unsigned char* x204 = CTYPES_PTR_OF_OCAML_BYTES(x201);
   EverCrypt_Hash_Incremental_finish(x203, x204);
   return Val_unit;
}
value _32_EverCrypt_Hash_Incremental_free(value x206)
{
   struct Hacl_Streaming_Functor_state_s___EverCrypt_Hash_state_s_____s* x207
   = CTYPES_ADDR_OF_FATPTR(x206);
   EverCrypt_Hash_Incremental_free(x207);
   return Val_unit;
}
