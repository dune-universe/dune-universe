---
title: ppx_log Testing
parent: ../README.md
uuid: b0922d56-1bce-3edd-bc1f-566091d64fe4
---
...
then Ppx_log_syntax.sexp ~level:`Debug log [%message ARGS]
else ()
```
...
then Ppx_log_syntax.Global.sexp ~level:`Debug [%message ARGS]
else ()
```
...
We can open `Ppx_log_async` to provide a `Ppx_log_syntax`.
...
`Ppx_log_async.No_global` instead:
...
customize behavior.  `Ppx_log_async.No_global` is an example of this.
